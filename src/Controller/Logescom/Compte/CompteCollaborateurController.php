...
class CompteCollaborateurController extends AbstractController
{
    ...
    public function detailCompte(LieuxVentes $lieu_vente, UserRepository $userRep, Request $request, MouvementCollaborateurRepository $mouvementRep, ConfigurationLogicielRepository $configRep, DeviseRepository $deviseRep, EntrepriseRepository $entrepriseRep): Response
    {
